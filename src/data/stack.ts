...
export const stack: StackItem[] = [
  ...
  { name: "Snyk", category: "Ferramentas", iconUrl: `https://cdn.simpleicons.org/snyk/4C4A73`, color: "#8C5BC7" },
  { name: "Postman", category: "Ferramentas", iconUrl: `${DEVICON}/postman/postman-original.svg`, color: "#FF6C37" },
  { name: "IntelliJ IDEA", category: "Ferramentas", iconUrl: `${DEVICON}/intellij/intellij-original.svg`, color: "#F04E98" },
];
